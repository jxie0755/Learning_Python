...
class Solution:
    def countSubstrings(self, s):  # not very fast?
    ...
    def countSubstrings(self, s):  # without generator, even slower
        count = 0
    ...
    def countSubstrings(self, s):  # a modification from above center expanding algorithm
