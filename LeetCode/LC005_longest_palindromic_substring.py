...
if __name__ == "__main__":
    ...
    assert testCase.longestPalindrome("bababadddddddddddd") == "dddddddddddd", "Additional 1"
    assert testCase.longestPalindrome("babababa") == "abababa" or "bababab", "Additional 2"
