...
def sum_largest(n, k):
    ...
    return _____________________________________________________________________________(a, b)

# c
X = (lambda a, x: x + (lambda y: lambda z: y+z+1000)(1000 _____ 10 _____ 5, _____ lambda: 8 _____ )
assert X == 2018
